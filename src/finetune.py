...
# deepspeed --master_port 61000 --include "localhost:3,4" finetune.py --data_file ../data/finetune_data/bbh_src_data.json --save_dir ../checkpoints/

def get_options():
    args = argparse.ArgumentParser()
    # data options
    args.add_argument("--data_file", type=str, default="../data/finetune_data/bbh_src_data.json")
...
if __name__ == '__main__':
    ...
    sa = StudyAssistant(model_name_or_path=model_name_or_path, padding_side=args.padding_strategy)

    run_name = datetime.datetime.now().strftime("%Y%m%d_%H%M%S")
    data_module = make_supervised_data_module(tokenizer=sa.tokenizer)
